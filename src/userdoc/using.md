 ...
 * Start by defining the System Of Interest(SOI) and then, users, environmental influences, and other systems to which the SOI will interface, using the [System Context Definition Viewpoint](./Conceptual%20Domain/System%20Context%20Definition%20Viewpoint.md)
...
### Tell Stories about System Usage
  * Using the contexts and context elements defined earlier, create system use cases, using the [System Use Case Viewpoint](./Conceptual%20Domain/System%20Use%20Case%20Viewpoint.md)

    The goal is, to tell the most important stories about the system happening in the contexts, and which key interactions with users, other systems or the environment happen during these stories. There is no need to use formal language, or a structured text approach - SAF has a specific [System Process Viewpoint](./Conceptual%20Domain/System%20Process%20Viewpoint.md)  to refine Use Cases formally. 

    However, if there are important system states as a precondition or as a result (postcondition) of a Use Case, they should be defined on the fly using the [System State Viewpoint](./Conceptual%20Domain/System%20State%20Viewpoint.md) and recorded in the Use Case.
 ...
 * For each Use Case create a system process using the  [System Process Viewpoint](./Conceptual%20Domain/System%20Process%20Viewpoint.md).
   ...
   The consolidation of System Functions is assisted by the [System Functional Breakdown Structure Viewpoint](./Conceptual%20Domain/System%20Functional%20Breakdown%20Structure%20Viewpoint.md). This viewpoint also gives an overview about the functional tree of the system and the usages of System Functions in System Processes.

   For the definition of exchanged items, use the [System Exchange Type Definition Viewpoint](./Conceptual%20Domain/System%20Exchange%20Type%20Definition%20Viewpoint.md).

   If system states are preconditions for the execution of System Functions use the [System State Viewpoint](./Conceptual%20Domain/System%20State%20Viewpoint.md) to define them.

   If necessary to explain the System Functions in more detail, use the [System Functional Refinement Viewpoint](./Conceptual%20Domain/System%20Functional%20Refinement%20Viewpoint.md)
