# SAF Development Documentation : Concepts : cross-domain FD-OD mapping wallpaper 
![SAF_cross-domain FD-OD mapping wallpaper Definition.svg](./diagrams/SAF_cross-domain-FD-OD-mapping-wallpaper-Definition.svg)
