...
| Operational Connection | Specifies the connection between Operational Context Performer Constituents in an Operational Context allowing Operational Item Exchange.<br><br>Aliases:<br>UAF::OperationalConnector|
