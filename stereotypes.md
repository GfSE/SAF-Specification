...
||SAF_ContextElementCharacterization||SSHrepresentingSCE<BR><BR>Specifies the fact that a SOI Stakeholder represents a System Context Element.<BR>|
...
||SAF_SFV03b_View||[System Function Refinement Viewpoint](viewpoints/System-Function-Refinement-Viewpoint.md)<BR>|
...
||SAF_StakeholderRelation||relatedTO<BR><BR>Explains relations between the Stakeholders of the system and other relevant system parties. It helps to understand the Stakeholder community and to approach the right point of contact for clarification of project relevant issues.<BR>|
